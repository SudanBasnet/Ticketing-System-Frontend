...
export const mapIncidentFromApi = (incident) => ({
  ...
  assignmentGroup: incident.assignmentGroup || (incident.assignedTo ? "Assigned Queue" : "Unassigned"),
  assignedTo: incident.assignedTo?.name || "",
  slaStatus: titleCase(incident.slaStatus || (incident.status === "closed" ? "met" : "on_track")),
